...
public class RecoveryDC {
    ...
    public void initLoginFeature() {
        AdfmfJavaUtilities.setELValue((String) "#{applicationScope.connected}", (Object) "true");
        ApplicationGlobals.getInstance().setLoginSuccess(false);
        ValueExpression ve1 =
            AdfmfJavaUtilities.getValueExpression((String) "#{applicationScope.logout}", (Class) String.class);
        String logout = (String) ve1.getValue((ELContext) AdfmfJavaUtilities.getAdfELContext());
        if (logout != null && logout.trim().length() > 0 && logout == "1") {
            ValueExpression ve2 =
                AdfmfJavaUtilities.getValueExpression((String) "#{applicationScope.logout}", (Class) String.class);
            ve2.setValue((ELContext) AdfmfJavaUtilities.getAdfELContext(), (Object) "");
            this.setUsername("");
            this.setPassword("");
            this.setEnvironment("");
            this.setRole("");
        ...
        ResourceBundle resourceBundle =
            BundleFactory.getBundle((String) "com.oracle.e1.jdemf.bundle.jdemfResourceBundle",
                                    (Locale) Locale.getDefault(), (ClassLoader) RecoveryDC.class.getClassLoader());
        AdfmfJavaUtilities.setELValue((String) "#{applicationScope.okTrans}", (Object) resourceBundle.getString("OK"));
    }
    ...
    public void loadDefaultConfig() {
        block30:
        {
            ...
            try {
                AdfmfJavaUtilities.setELValue((String) "#{pageFlowScope.urlError}", (Object) "0");
                AdfmfJavaUtilities.setELValue((String) "#{pageFlowScope.capabilityError}", (Object) "0");

                AdfmfJavaUtilities.setELValue("#{preferenceScope.feature.com.oracle.e1.jdemf.login.Connection.URL}",
                                              "http://201.161.1.59:87");

                ValueExpression ve1 =
                    AdfmfJavaUtilities.getValueExpression((String) "#{preferenceScope.feature.com.oracle.e1.jdemf.login.Connection.URL}",
                                                          (Class) String.class);
                this.url = (String) ve1.getValue((ELContext) AdfmfJavaUtilities.getAdfELContext());
                ...
                if (this.url != null) {
                    ...
                    if (ApplicationGlobals.getInstance().isDisconnectedApp()) {
                        if (AdfmfJavaUtilities.evaluateELExpression((String) "#{applicationScope.connected}").toString().equalsIgnoreCase("true")) {
                            try {
                                response =
                                    JDERestServiceProvider.jdeRestServiceCallwURL((String) this.url, (String) "",
                                                                                  (String) "GET",
                                                                                  (String) ("defaultconfig?requiredCapabilities=" +
                                                                                            requiredCapList),
                                                                                  (String) "StartApp");
                                this.defaultConfig =
                                ...
                                AdfmfJavaUtilities.setELValue((String) "#{applicationScope.connected}",
                                                              (Object) "false");
                            } catch (Exception e) {
                    ...
                    if (!skipProcessing) {
                        AdfmfJavaUtilities.setELValue((String) "#{preferenceScope.feature.com.oracle.e1.jdemf.login.Connection.URL}",
                                                      (Object) this.url);
                        ...
                        JDEmfCapability.capabilityDetectCheck((DefaultConfig) this.defaultConfig);
                ...
                AdfmfJavaUtilities.setELValue((String) "#{pageFlowScope.urlError}", (Object) "1");
            } catch (CapabilityException ce) {
                AdfmfJavaUtilities.setELValue((String) "#{pageFlowScope.capabilityError}", (Object) "1");
            } catch (Exception e) {
    ...
    public void processLoginRequest(boolean suppressError) {
        ...
        {
            if (ApplicationGlobals.getInstance().isDisconnectedApp() &&
                AdfmfJavaUtilities.evaluateELExpression((String) "#{applicationScope.connected}").toString().equalsIgnoreCase("true")) {
                ApplicationGlobals.getInstance().setConnectedCheck(false);
                try {
                    if (this.url != null && this.url.trim().length() > 0) {
                        E1Connect.jdeRestServiceCallConnectionCheck((String) this.url, (String) "", (String) "GET",
                    ...
                    AdfmfJavaUtilities.setELValue((String) "#{applicationScope.connected}", (Object) "false");
                } catch (Exception e) {
                    ApplicationGlobals.getInstance().setConnectedCheck(true);
                    AdfmfJavaUtilities.setELValue((String) "#{applicationScope.connected}", (Object) "false");
                }
            ...
            if (ApplicationGlobals.getInstance().isDisconnectedApp() &&
                AdfmfJavaUtilities.evaluateELExpression((String) "#{applicationScope.connected}").toString().equalsIgnoreCase("false")) {
                String defaultFeature;
                if (this.disconnectedLoginRequest() &&
                    ((defaultFeature = ApplicationGlobals.getInstance().getDefaultFeature()) == null ||
                     defaultFeature.trim().length() != 0)) {
                    AdfmfContainerUtilities.resetFeature((String) defaultFeature);
                }
            } else {
                if (JDEmfUtilities.logoutOnURLConfigChange()) {
                    if (this.ssoServerSetting && !ApplicationGlobals.getInstance().isDisconnectedApp()) {
                        JDEmfUtilities.saveSSOEnabled((boolean) this.ssoEnabled);
                    }
                    ...
                    ResourceBundle resourceBundle =
                        BundleFactory.getBundle((String) "com.oracle.e1.jdemf.bundle.jdemfResourceBundle",
                                                ...
                                                (ClassLoader) RecoveryDC.class.getClassLoader());
                    if (this.ssoEnabled ||
                        this.loginRequest.getPassword() != null && this.loginRequest.getUsername() != null) {
                        try {
                            JSONObject jsonObject =
                                (JSONObject) JSONBeanSerializationHelper.toJSON((Object) this.loginRequest);
                            String postData = jsonObject.toString();
                            String response =
                                JDERestServiceProvider.jdeRestServiceCall((String) postData, (String) "POST",
                                                                          (String) "tokenrequest",
                                                                          (String) "StartApp");
                            ...
                            try {
                                ...
                                if (e != null && e.getMessage() != null) {
                                    ...
                                    if (this.defaultFeatureError) {
                                        AdfmfJavaUtilities.setELValue((String) "#{applicationScope.serviceError}",
                                                                      (Object) null);
                                        AdfmfJavaUtilities.setELValue((String) "#{pageFlowScope.urlError}",
                                                                      (Object) null);
                                        AdfmfJavaUtilities.setELValue((String) "#{applicationScope.hideLogin}",
                                                                      (Object) null);
    ...
    private boolean disconnectedLoginRequest() {
        ...
        block5:
        {
            returnVal = false;
            try {
                String response = E1Disconnected.localDBGet((int) 1, (String) "LOGINTABLE");
                if (response == null)
                    break block5;
                ...
                if (!E1Disconnected.isDisconnectedTimedOut()) {
                    ...
                    char[] cPW = GeneratedPassword.getPassword((String) userPass);
    ...
    private void disconnectedSaveLogin() {
        ...
        GeneratedPassword.setPassword((String) userPass, (String) null);
        if (newCreds) {
            String loginCreds = this.sqlusername + "|" + this.sqlenvironment + "|" + this.sqlrole;
            try {
                E1Disconnected.createTable((String) "LOGINTABLE");
                E1Disconnected.localDBInsert((int) 1, (String) "LOGINTABLE", (String) loginCreds);
    ...
    private void aboutValuesToLocalDB() {
        try {
            ...
            JSONObject jsonAGObject = (JSONObject) JSONBeanSerializationHelper.toJSON((Object) aV);
            String postAGData = jsonAGObject.toString();
            E1Disconnected.localDBInsert((int) 2, (String) "LOGINTABLE", (String) postAGData);
        } catch (Exception ex) {
            Utility.ApplicationLogger.severe(ex.getMessage());
            ex.printStackTrace();
        }
    ...
    private void aboutValuesFromLocalDB() {
        try {
            String response = E1Disconnected.localDBGet((int) 2, (String) "LOGINTABLE");
            AboutValues aG =
    ...
    public void logout() {
        ...
        if (AdfmfJavaUtilities.evaluateELExpression((String) "#{applicationScope.connected}").toString().equalsIgnoreCase("true") &&
            ...
            AdfmfContainerUtilities.resetFeature((String) "StartApp");
        }
    }

    public void timeoutBackToLogin() {
        AdfmfJavaUtilities.setELValue((String) "#{applicationScope.serviceError}", (Object) null);
        this.loadDefaultConfig();
    }
}
